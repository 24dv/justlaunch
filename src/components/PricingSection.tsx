          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
              <div className="p-8">
                ...
                <a
                  href="#contact"
                  className="block w-full py-3 px-4 rounded-lg bg-black text-white text-center font-medium hover:bg-gray-900 transition-colors"
                >
                  Get Started
                </a>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-md overflow-hidden border border-gray-200">
              <div className="p-8">
                ...
                <a
                  href="#contact"
                  className="block w-full py-3 px-4 rounded-lg bg-white border border-gray-300 text-gray-900 text-center font-medium hover:bg-gray-50 transition-colors"
                >
                  Choose Payment Plan
                </a>
              </div>
              <div className="px-8 pb-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <div className="flex-shrink-0 h-6 w-6 rounded-full bg-gray-200 flex items-center justify-center text-xs font-bold mr-3">
                      1
                    </div>
                    <div>
                      <p className="text-gray-700">
                        Pay €500 to start your project
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      <p className="text-gray-700">
                        Second payment of €500 after first draft approval
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      <p className="text-gray-700">
                        Final payment of €500 before delivery of completed files
                      </p>
                    </div>
                  </li>
                </ul>
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <p className="text-sm text-gray-500">
                    Available for both packages. Total cost remains the same.
                  </p>
                </div>
              </div>
            </div>
