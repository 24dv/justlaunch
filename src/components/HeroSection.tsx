...
const HeroSection = () => {
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center pt-24 pb-10 relative overflow-hidden">
      ...
      {/* Abstract shapes */}
      <div className="absolute top-[10%] right-[10%] w-[300px] h-[300px] rounded-full bg-blue-50 opacity-40 blur-3xl -z-10" />
      <div className="absolute bottom-[15%] left-[15%] w-[250px] h-[250px] rounded-full bg-yellow-50 opacity-40 blur-3xl -z-10" />
      ...
      <div className="container mx-auto px-6 relative">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <div className="inline-flex animate-fade-in-up items-center rounded-full border border-gray-200 bg-white px-4 py-1.5 mb-6 text-sm font-medium text-gray-700">
            <span className="rounded-full bg-brand-500 mr-2 px-2 py-0.5 text-xs text-white">New</span> 
            Launch your brand in days, not months
          </div>
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight animate-fade-in-up animate-delay-100 text-balance">
            Launch Your Brand Fast—From Idea to Online in Days!
          </h1>
          
          <p className="text-xl text-gray-600 mb-10 max-w-2xl animate-fade-in-up animate-delay-200 text-balance">
            Get a professional logo and landing page for just €1,500. No hidden costs, no hassle.
          </p>
          
          <a 
            href="#contact"
            className="animate-scale-up animate-delay-300 inline-flex items-center justify-center rounded-lg bg-black px-8 py-3.5 text-base md:text-lg font-medium text-white shadow-sm hover:bg-gray-900 transition-all duration-200 ease-in-out transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
          >
            Get Started Today
          </a>
