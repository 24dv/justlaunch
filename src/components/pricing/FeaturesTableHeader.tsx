  ...
  return (
    <div className="bg-[#0D503C]/10 border-b border-[#0D503C]/20 sticky top-0 z-10">
      <table className="w-full table-fixed">
        <thead>
          <TableRow>
            <TableHead className="w-[40%] font-semibold text-[#0D503C] p-2 md:p-4 text-sm md:text-base">
              {language === 'en' ? 'Features' : 'Functies'}
            </TableHead>
            <TableHead className="text-center font-semibold text-[#0D503C] p-2 md:p-4 w-[20%] text-xs md:text-sm">
