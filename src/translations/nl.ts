...
const translations = {
  ...
  "comparison.subtitle": "Bekijk hoe wij ons verhouden tot de alternatieven voor het lanceren van je merk online",
  "comparison.category": "Categorie",
  "comparison.justLaunch": "Just Launch",
  "comparison.agency": "Traditioneel Bureau",
  "comparison.freelancer": "Freelancer",
  "comparison.diy": "Zelf Doen",
  "comparison.upfrontCost": "Opstartkosten",
  "comparison.ongoingCost": "Doorlopende Kosten",
  "comparison.timeToLaunch": "Tijd Tot Lancering",
  "comparison.days": "dagen",
  "comparison.weeks": "weken",
  "comparison.week": "week",
  "comparison.months": "maanden",
  "comparison.designQuality": "Ontwerpkwaliteit",
  "comparison.easeOfProcess": "Gemak van Proces",
  "comparison.scalability": "Schaalbaarheid",
  "comparison.clientAttraction": "Klantaantrekking",
  "comparison.professionalCustom": "Professioneel, op maat gemaakt logo & website",
  "comparison.belgiumDesigners": "Belgische designers, geoptimaliseerd voor mobiel",
  "comparison.doneForYou": "Volledig verzorgd:",
  "comparison.minimalEffort": "Minimale inspanning",
  "comparison.weHandle": "Wij regelen ontwerp, techniek, setup; 1 revisieronde",
  "comparison.easyToScale": "Makkelijk schaalbaar:",
  "comparison.addPagesFeatures": "Voeg later pagina's, functies of e-commerce toe",
  "comparison.tenEuroMo": "€10/maand houdt het veilig",
  "comparison.builtToConvert": "Gebouwd om te converteren:",
  "comparison.clearCTAs": "Duidelijke CTA's, SEO-vriendelijk",
  "comparison.tailoredForAudience": "Op maat gemaakt voor je doelgroep",
  "comparison.highlyCustom": "Volledig op maat, premium",
  "comparison.oftenOverkill": "Vaak te uitgebreid voor startups",
  "comparison.highEffort": "Veel inspanning:",
  "comparison.multipleMeetings": "Meerdere vergaderingen, revisies, goedkeuringen",
  "comparison.scalableCostly": "Schaalbaar maar duur:",
  "comparison.featuresExpensive": "Nieuwe functies vaak €1.000+",
  "comparison.strongConversion": "Sterke focus op conversie",
  "comparison.costlySlow": "Maar duur en traag",
  "comparison.professionalInconsistent": "Professioneel maar inconsistent",
  "comparison.dependsFreelancer": "Afhankelijk van freelancer-vaardigheden",
  "comparison.moderateEffort": "Gemiddelde inspanning:",
  "comparison.manageFreelancer": "Aansturen freelancer, revisies, communicatie",
  "comparison.limited": "Beperkt:",
  "comparison.scalingDependsFreelancer": "Schaalbaarheid afhankelijk van beschikbaarheid en vaardigheden freelancer",
  "comparison.varies": "Varieert:",
  "comparison.conversionFreelancer": "Focus op conversie hangt af van expertise freelancer",
  "comparison.templateBased": "Op templates gebaseerd, risico op generiek uiterlijk",
  "comparison.dependsSkill": "Afhankelijk van vaardigheden",
  "comparison.learnTroubleshoot": "Leer Canva/Wix, ontwerp, los problemen op",
  "comparison.steepLearning": "Steile leercurve",
  "comparison.templatesRestrict": "Templates beperken groei; schalen vereist vaak opnieuw beginnen",
  "comparison.basic": "Basis:",
  "comparison.limitedSEO": "Beperkte SEO/UX tenzij je vaardig bent of plugins koopt",
  "comparison.readyToLaunch": "Ben Ik Klaar Om Te Lanceren?",
  "comparison.seeWhatWeCanDo": "Bekijk wat we in 14 dagen voor je kunnen doen!",
