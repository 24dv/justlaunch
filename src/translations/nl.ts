const translations = {
  ...
  "contact.subtitle": "Vul het formulier in voor een kort introgesprek. Geen verplichtingen, gewoon een snel gesprek om te zien of we bij elkaar passen.",
  "contact.nextSteps": "Zo gaat het in zijn werk:",
  "contact.step1": "Plan een kort introgesprek om het proces door te nemen en je vragen te beantwoorden",
  "contact.step2": "Als het klikt, sturen we je een slim intakeformulier om jouw verhaal en stijl vast te leggen",
  "contact.step3": "Vanaf daar gaan we aan de slag — ontwerp, bouw, lancering, alles binnen 14 dagen",
