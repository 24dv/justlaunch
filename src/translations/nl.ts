const translations = {
  ...
  // Comparison Section
  "comparison.title": "Just Launch (€1.500) vs. Bureau vs. Freelancer vs. Zelf Doen",
  "comparison.subtitle": "Zie hoe we ons verhouden tot de alternatieven voor het lanceren van jouw merk online",
  "comparison.category.upfrontCost": "Initiële Kosten",
  "comparison.category.ongoingCost": "Lopende Kosten",
  "comparison.category.timeToLaunch": "Tijd tot Lancering",
  "comparison.category.designQuality": "Ontwerpkwaliteit",
  "comparison.category.easeOfProcess": "Gemak van Proces",
  "comparison.category.scalability": "Schaalbaarheid",
  "comparison.category.clientAttraction": "Klantwerving",
  
  "comparison.justLaunch.upfrontCost": "€1.500",
  "comparison.justLaunch.ongoingCost": "€10/mnd",
  "comparison.justLaunch.timeToLaunch": "14 dagen",
  "comparison.justLaunch.designQuality.title": "Professioneel, op maat gemaakt logo & website",
  "comparison.justLaunch.designQuality.subtitle": "Belgische ontwerpers, geoptimaliseerd voor mobiel",
  "comparison.justLaunch.easeOfProcess.title": "Voor je gedaan:",
  "comparison.justLaunch.easeOfProcess.subtitle": "Minimale inspanning",
  "comparison.justLaunch.easeOfProcess.description": "Wij regelen ontwerp, techniek, setup; 1 revisieronde",
  "comparison.justLaunch.scalability.title": "Eenvoudig te schalen:",
  "comparison.justLaunch.scalability.subtitle": "Later pagina's, functies of e-commerce toevoegen",
  "comparison.justLaunch.scalability.description": "€10/mnd houdt het veilig",
  "comparison.justLaunch.clientAttraction.title": "Gemaakt om te converteren:",
  "comparison.justLaunch.clientAttraction.subtitle": "Duidelijke CTA's, SEO-vriendelijk",
  "comparison.justLaunch.clientAttraction.description": "Op maat gemaakt voor jouw publiek",
  
  "comparison.agency.upfrontCost": "€4.000-€8.000",
  "comparison.agency.ongoingCost": "€100-€150/mnd",
  "comparison.agency.timeToLaunch": "4-12 weken",
  "comparison.agency.designQuality.title": "Zeer op maat, premium",
  "comparison.agency.designQuality.description": "Vaak overdreven voor startups",
  "comparison.agency.easeOfProcess.title": "Veel inspanning:",
  "comparison.agency.easeOfProcess.description": "Meerdere vergaderingen, revisies, goedkeuringen",
  "comparison.agency.scalability.title": "Schaalbaar maar kostbaar:",
  "comparison.agency.scalability.description": "Nieuwe functies vaak €1.000+",
  "comparison.agency.clientAttraction.title": "Sterke focus op conversie",
  "comparison.agency.clientAttraction.description": "Maar kostbaar en traag",
  
  "comparison.freelancer.upfrontCost": "€2.500-€5.000",
  "comparison.freelancer.ongoingCost": "€30-€50/mnd",
  "comparison.freelancer.timeToLaunch": "3-5 weken",
  "comparison.freelancer.designQuality.title": "Professioneel maar inconsistent",
  "comparison.freelancer.designQuality.description": "Afhankelijk van de vaardigheden van de freelancer",
  "comparison.freelancer.easeOfProcess.title": "Gemiddelde inspanning:",
  "comparison.freelancer.easeOfProcess.description": "Beheer freelancer, revisies, communicatie",
  "comparison.freelancer.scalability.title": "Beperkt:",
  "comparison.freelancer.scalability.description": "Schaling afhankelijk van beschikbaarheid en vaardigheden freelancer",
  "comparison.freelancer.clientAttraction.title": "Varieert:",
  "comparison.freelancer.clientAttraction.description": "Conversiefocus afhankelijk van expertise van freelancer",
  
  "comparison.diy.upfrontCost": "€0-€500",
  "comparison.diy.ongoingCost": "€5-€50/mnd",
  "comparison.diy.timeToLaunch": "1 week-3 maanden",
  "comparison.diy.designQuality.title": "Template-gebaseerd, risico om generiek te lijken",
  "comparison.diy.designQuality.description": "Afhankelijk van vaardigheid",
  "comparison.diy.easeOfProcess.title": "Veel inspanning:",
  "comparison.diy.easeOfProcess.description": "Leer Canva/Wix, ontwerp, probleemoplossing",
  "comparison.diy.easeOfProcess.subtitle": "Steile leercurve",
  "comparison.diy.scalability.title": "Beperkt:",
  "comparison.diy.scalability.description": "Templates beperken groei; schaling vereist vaak opnieuw beginnen",
  "comparison.diy.clientAttraction.title": "Basis:",
  "comparison.diy.clientAttraction.description": "Beperkte SEO/UX tenzij je vaardig bent of plugins koopt",
  
  "comparison.cta.bookCall": "Plan Je Gratis Introgesprek",
  "comparison.cta.takeQuiz": "Ben Ik Klaar Om Te Lanceren?",
  "comparison.cta.seeWork": "Bekijk wat we voor jou kunnen doen in 14 dagen!",
