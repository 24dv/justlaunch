...
const translations = {
  ...
  "comparison.agency": "Traditional Agency",
  "comparison.freelancer": "Freelancer",
  "comparison.diy": "DIY",
  "comparison.upfrontCost": "Upfront Cost",
  "comparison.ongoingCost": "Ongoing Cost",
  "comparison.timeToLaunch": "Time to Launch",
  "comparison.days": "days",
  "comparison.weeks": "weeks",
  "comparison.week": "week",
  "comparison.months": "months",
  "comparison.designQuality": "Design Quality",
  "comparison.easeOfProcess": "Ease of Process",
  "comparison.scalability": "Scalability",
  "comparison.clientAttraction": "Client Attraction",
  "comparison.professionalCustom": "Professional, custom logo & website",
  "comparison.belgiumDesigners": "Belgium designers, mobile-optimized",
  "comparison.doneForYou": "Done-for-you:",
  "comparison.minimalEffort": "Minimal effort",
  "comparison.weHandle": "We handle design, tech, setup; 1 revision round",
  "comparison.easyToScale": "Easy to scale:",
  "comparison.addPagesFeatures": "Add pages, features, or e-commerce later",
  "comparison.tenEuroMo": "€10/mo keeps it secure",
  "comparison.builtToConvert": "Built to convert:",
  "comparison.clearCTAs": "Clear CTAs, SEO-friendly",
  "comparison.tailoredForAudience": "Tailored for your audience",
  "comparison.highlyCustom": "Highly custom, premium",
  "comparison.oftenOverkill": "Often overkill for startups",
  "comparison.highEffort": "High effort:",
  "comparison.multipleMeetings": "Multiple meetings, revisions, approvals",
  "comparison.scalableCostly": "Scalable but costly:",
  "comparison.featuresExpensive": "New features often €1,000+",
  "comparison.strongConversion": "Strong conversion focus",
  "comparison.costlySlow": "But costly and slow",
  "comparison.professionalInconsistent": "Professional but inconsistent",
  "comparison.dependsFreelancer": "Depends on freelancer skill",
  "comparison.moderateEffort": "Moderate effort:",
  "comparison.manageFreelancer": "Manage freelancer, revisions, communication",
  "comparison.limited": "Limited:",
  "comparison.scalingDependsFreelancer": "Scaling depends on freelancer availability, skills",
  "comparison.varies": "Varies:",
  "comparison.conversionFreelancer": "Conversion focus depends on freelancer expertise",
  "comparison.templateBased": "Template-based, risks looking generic",
  "comparison.dependsSkill": "Depends on skill",
  "comparison.learnTroubleshoot": "Learn Canva/Wix, design, troubleshoot",
  "comparison.steepLearning": "Steep learning curve",
  "comparison.templatesRestrict": "Templates restrict growth; scaling often requires starting over",
  "comparison.basic": "Basic:",
  "comparison.limitedSEO": "Limited SEO/UX unless you're skilled or buy plugins",
  "comparison.readyToLaunch": "Am I Ready to Launch?",
  "comparison.seeWhatWeCanDo": "See what we can do for you in 14 days!",
