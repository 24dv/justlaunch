const translations = {
  ...
  "nav.freeIntroCall": "Free Intro Call",
  ...
  // Comparison Section
  "comparison.title": "Just Launch (€1,500) vs. Agency vs. Freelancer vs. DIY",
  "comparison.subtitle": "See how we compare to the alternatives for launching your brand online",
  "comparison.category.upfrontCost": "Upfront Cost",
  "comparison.category.ongoingCost": "Ongoing Cost",
  "comparison.category.timeToLaunch": "Time to Launch",
  "comparison.category.designQuality": "Design Quality",
  "comparison.category.easeOfProcess": "Ease of Process",
  "comparison.category.scalability": "Scalability",
  "comparison.category.clientAttraction": "Client Attraction",
  
  "comparison.justLaunch.upfrontCost": "€1,500",
  "comparison.justLaunch.ongoingCost": "€10/mo",
  "comparison.justLaunch.timeToLaunch": "14 days",
  "comparison.justLaunch.designQuality.title": "Professional, custom logo & website",
  "comparison.justLaunch.designQuality.subtitle": "Belgium designers, mobile-optimized",
  "comparison.justLaunch.easeOfProcess.title": "Done-for-you:",
  "comparison.justLaunch.easeOfProcess.subtitle": "Minimal effort",
  "comparison.justLaunch.easeOfProcess.description": "We handle design, tech, setup; 1 revision round",
  "comparison.justLaunch.scalability.title": "Easy to scale:",
  "comparison.justLaunch.scalability.subtitle": "Add pages, features, or e-commerce later",
  "comparison.justLaunch.scalability.description": "€10/mo keeps it secure",
  "comparison.justLaunch.clientAttraction.title": "Built to convert:",
  "comparison.justLaunch.clientAttraction.subtitle": "Clear CTAs, SEO-friendly",
  "comparison.justLaunch.clientAttraction.description": "Tailored for your audience",
  
  "comparison.agency.upfrontCost": "€4,000-€8,000",
  "comparison.agency.ongoingCost": "€100-€150/mo",
  "comparison.agency.timeToLaunch": "4-12 weeks",
  "comparison.agency.designQuality.title": "Highly custom, premium",
  "comparison.agency.designQuality.description": "Often overkill for startups",
  "comparison.agency.easeOfProcess.title": "High effort:",
  "comparison.agency.easeOfProcess.description": "Multiple meetings, revisions, approvals",
  "comparison.agency.scalability.title": "Scalable but costly:",
  "comparison.agency.scalability.description": "New features often €1,000+",
  "comparison.agency.clientAttraction.title": "Strong conversion focus",
  "comparison.agency.clientAttraction.description": "But costly and slow",
  
  "comparison.freelancer.upfrontCost": "€2,500-€5,000",
  "comparison.freelancer.ongoingCost": "€30-€50/mo",
  "comparison.freelancer.timeToLaunch": "3-5 weeks",
  "comparison.freelancer.designQuality.title": "Professional but inconsistent",
  "comparison.freelancer.designQuality.description": "Depends on freelancer skill",
  "comparison.freelancer.easeOfProcess.title": "Moderate effort:",
  "comparison.freelancer.easeOfProcess.description": "Manage freelancer, revisions, communication",
  "comparison.freelancer.scalability.title": "Limited:",
  "comparison.freelancer.scalability.description": "Scaling depends on freelancer availability, skills",
  "comparison.freelancer.clientAttraction.title": "Varies:",
  "comparison.freelancer.clientAttraction.description": "Conversion focus depends on freelancer expertise",
  
  "comparison.diy.upfrontCost": "€0-€500",
  "comparison.diy.ongoingCost": "€5-€50/mo",
  "comparison.diy.timeToLaunch": "1 week-3 months",
  "comparison.diy.designQuality.title": "Template-based, risks looking generic",
  "comparison.diy.designQuality.description": "Depends on skill",
  "comparison.diy.easeOfProcess.title": "High effort:",
  "comparison.diy.easeOfProcess.description": "Learn Canva/Wix, design, troubleshoot",
  "comparison.diy.easeOfProcess.subtitle": "Steep learning curve",
  "comparison.diy.scalability.title": "Limited:",
  "comparison.diy.scalability.description": "Templates restrict growth; scaling often requires starting over",
  "comparison.diy.clientAttraction.title": "Basic:",
  "comparison.diy.clientAttraction.description": "Limited SEO/UX unless you're skilled or buy plugins",
  
  "comparison.cta.bookCall": "Book Your Free Intro Call",
  "comparison.cta.takeQuiz": "Am I Ready to Launch?",
  "comparison.cta.seeWork": "See what we can do for you in 14 days!",
  ...
  // Quiz Popup & Footer
  "quiz.popup.title": "Not sure you're ready to launch?",
  "quiz.popup.description": "Take our 2-minute quiz and get clarity.",
  "quiz.popup.buttonText": "Start Quiz",
  "quiz.footer.title": "Still figuring things out?",
  "quiz.footer.description": "Take our 2-minute quiz and find out if you're ready to launch.",
  "quiz.footer.buttonText": "Take the Quiz",
