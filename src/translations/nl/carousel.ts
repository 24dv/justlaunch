...
const carousel = {
  ...
  "carousel.subtitle": "Van coaches tot bakkers, creatievelingen tot consultants, we helpen mensen zoals jij hun droom tot leven te brengen op een manier die écht voelt en er pro uitziet.",
