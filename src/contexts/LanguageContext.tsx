...
const translations = {
  en: {
    ...
    "hero.subtitle": "Get a professional logo and website for just €1,500. Transparent cost, no hassle.",
  ...
  nl: {
    ...
    "hero.subtitle": "Krijg een professioneel logo en website voor slechts €1.500. Transparante kosten, geen gedoe.",
